...
window.onload = function(){
    ...
    Enter.addEventListener("keydown", function(e){ 
        ...
        if (e.keyCode == 13 && document.getElementById("textInput").value === "")    ///*inmatningen för enter knappen *//
                {e.preventDefault()}                                       
        ...
        
        {
            e.preventDefault()
            date = new Date();
            myObj = new Message(text.value, date)                         ///* skapar ny object om shift-enter är icke lika med tom *//
            messages.push(myObj);
    ...
    var renderMessage = function(index){
        ...
        img.src = "picture/DeleteRed.png";
        
        clockimg.className = "ClockPicture";
        clockimg.src = "picture/Clock.png";
